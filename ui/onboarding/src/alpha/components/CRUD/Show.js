      ...
      <div class="container">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <Link to={`/edit/${this.state.contact.id}`} class="btn btn-success">Update</Link>&nbsp;
            <button onClick={this.delete.bind(this, this.state.contact.id)} class="btn btn-danger">Del</button>
          </div>
        </div>
      </div>
    );
